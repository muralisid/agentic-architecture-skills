...
**Figure: Access identity by default, presence by exception.** The agent identity is a service principal with the sponsor attribute; the user account carrying mailbox and meeting presence is a separate, optional, revocable grant.
