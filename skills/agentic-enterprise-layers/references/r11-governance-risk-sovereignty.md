...
**Figure: The registry-centred evidence machine.** The agent registry is the compliance inventory; evidence posture is two-tiered, and deployment is classification-routed for sovereignty.

Evidence floor for every production agent; Article-12-grade instrumentation for the plausibly high-risk tier.
