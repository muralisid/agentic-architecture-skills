...
**Figure: Buy the runtime, build the harness.** The harness owns context assembly, explicit multi-condition termination, artifacts-as-state, separate verification, and budgets; the managed runtime owns isolation and durability.

The harness is the lock-in and the differentiator; the runtime is becoming the portable substrate.
